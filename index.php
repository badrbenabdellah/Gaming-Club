...
<body class="body-home">
    <div class="black-fill"> <br> 
        ...
        <!-- Debut Partie de header Navbar avec Bootstrap -->
        <nav class="navbar navbar-expand-lg bg-body-tertiary" id="homeNav">
    	<div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="./images/_LOGO HD.png" alt="ICON" width="40">
            </a>
        ...
        <!-- Partie Partie de header Navbar avec Bootstrap -->

        <section class="welcome-text d-flex justify-content-center align-items-center flex-column">
            <img src="./images/_LOGO HD.png">
            <h4>Welcome to your Club</h4>
            <p>
        ...
        <div class="row g-0">
        <div class="col-md-4">
            <img src="./images/_LOGO HD.png" class="img-fluid rounded-start">
        </div>
        <div class="col-md-8">
        <div class="card-body">
