...
<body>
    ...
    $news = Database::getNewsPerPage($nombre_actualites_par_page, $offset);

    // Récupérer le nombre total d'actualités
    $total_actualites = Database::countNews();

    // Calculer le nombre total de pages
    $nombre_total_pages = ceil($total_actualites / $nombre_actualites_par_page);
    ?>
            ...
            <div class="row">
                <div class="col-lg-8 mb-5 mb-lg-0">
                    <div class="blog_left_sidebar">
                        <?php
                        while ($data = $news->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            <article class="blog_item">
                                ...
                                <div class="blog_details">
                                    <a class="d-inline-block" href="news-detail.php?id=<?php echo $data['nid']; ?>">
