...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($_POST['username']) && !empty($_POST['username']) && isset($_POST['email']) && !empty($_POST['email']) &&
        isset($_POST['password']) && !empty($_POST['password']) && $_FILES['profile_photo']['error'] == null) {
        ...
        if(in_array($extension_upload, $extensions_autorisees)) {
            ...
            Database::addUsers($_POST['username'], $_POST['email'], $hashed_password, $chemin_destination);
